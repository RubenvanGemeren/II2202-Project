...
def ratings_by_id():
    ...
    write_benchmark_to_file("benchmarks/gin_index/ratings_by_id.txt", benchmarks)
...
def ratings_by_range():
    ...
    write_benchmark_to_file("benchmarks/gin_index/ratings_by_range.txt", benchmarks)
...
def join_movies_ratings():
    ...
    write_benchmark_to_file("benchmarks/gin_index/join_movies_ratings.txt", benchmarks)
...
def join_and_group_by_title():
    ...
    write_benchmark_to_file("benchmarks/gin_index/group_by_title.txt", benchmarks)
...
def movies_by_genres():
    ...
    write_benchmark_to_file("benchmarks/gin_index/movies_by_genres.txt", benchmarks)
